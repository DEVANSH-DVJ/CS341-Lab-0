...
public:
   ...
   * @returns Pair of ints containing [Vertex number, Distance of vertex] for
...
private:
   ...
   * @details
   * index2HeapIdx[2] = 3 suggests that heap[3] contains distance of vertex
   * number 2
   */
   ...
   * @details
   * heapIdx2index[3] = 2 suggests that heap[3] contains distance of vertex
   * number 2
   */
...
private:
   ...
   * @note Will also take care of changing vertex number mappings on
   * index2HeapIdx[] and heapIdx2index
   */
